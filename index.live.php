...
$cpanel = new CPANEL();
print $cpanel->header( "Inodes Usage Summary" );
...
<li><a href="#" style="cursor:default;text-decoratio:none;">Inode usage for: <b><?php echo $path;?></b></a></li>                        
 </ul>
                </div>
            </nav>
...
exec('cd $path && /usr/local/cpanel/base/frontend/paper_lantern/inodes/./inodes', $output, $status);
